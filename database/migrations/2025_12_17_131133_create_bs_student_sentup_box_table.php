   ...
   public function up(): void
    {
         ...
         */
        DB::statement("
            CREATE TABLE bs_student_sentup_box (
                id BIGINT NOT NULL,
        ...
        for ($year = 2019; $year <= date('Y') + 1; $year++) {
            DB::statement("
                CREATE TABLE bs_student_sentup_box_{$year}
                PARTITION OF bs_student_sentup_box
                FOR VALUES IN ('{$year}');
            ");
        }
         ...
         */
        DB::statement("
            ALTER TABLE bs_student_sentup_box
         ...
         */
        DB::statement("
            CREATE INDEX idx_sentup_student_code
            ON bs_student_sentup_box (student_code);
        ");
    }

    public function down(): void
    {
        DB::statement("DROP TABLE IF EXISTS bs_student_sentup_box CASCADE;");
    }
};
